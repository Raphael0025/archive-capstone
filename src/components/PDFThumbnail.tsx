...
const PDFThumbnail: React.FC<PDFThumbnailProps> = ({data, width, height}) => {
  ...
  return (
    <Link href={`/publications/${id}`} className='rounded text-slate-100 p-2 md:w-52 mb-5 md:mb-0 cursor-pointer flex items-center justify-center gradient-link grad-1' style={{ height: `300px`}}>
