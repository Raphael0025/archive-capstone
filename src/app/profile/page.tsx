...
export default function Profile() {
    ...
    return (
        <main className='w-full h-dvh pt-20'>
            ...
            <section className='p-5 md:px-12 w-full'>
                <h1 className='text-3xl font-bold mb-4'>User Profile</h1>

                {user ? (
                    <div className='flex w-full flex-col md:flex-row justify-between items-start'>
                        <p className='w-full'>{user.userID === '' ? '' : `Student ID: ${user.userID}`}</p>
                    ...
                    <div className='w-full  table-auto border-collapse border border-slate-500'>
                        ...
                        <div key={index} className='hover:bg-gray-500 odd:bg-neutral-700 flex justify-between even:bg-neutral-800'>
                            <div className='md:hidden flex justify-center items-center w-full'>
                                <div className='flex flex-col w-1/2 space-x-0'>
                                    <div className='w-full p-2'>
                                        {inquiry.title}
                                    </div>
                                </div>
                                <div className='w-1/2 flex h-fit items-center justify-center space-x-4  p-2'>
